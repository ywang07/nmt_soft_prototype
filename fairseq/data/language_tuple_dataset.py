...
def collate(samples, pad_idx, eos_idx, left_pad_source=True, left_pad_target=False):
    ...
    src_tokens_2, src_lengths_2 = None, None
    if samples[0].get('source2', None) is not None:
        src_tokens_2 = merge('source2', left_pad=left_pad_source)
...
class LanguageTupleDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        return {
            ...
            'source2': self.src2[index] if self.src2 is not None else None,
        ...
        return self.collater([
            {
                ...
                'source2': self.src2_dict.dummy_sentence(src_len) if self.src2_dict is not None else None,
