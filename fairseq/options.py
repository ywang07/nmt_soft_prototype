...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--not-reload-opt', action='store_true',
                       help='not to reload auxiliary params for optimization')
...
def add_seqtrans_args(parser):
    ...
    group.add_argument('--fairseq-dir', default=None, metavar='PATH',
                       help='Path to fairseq code generate.py')
